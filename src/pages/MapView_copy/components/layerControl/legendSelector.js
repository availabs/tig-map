...
import { updateLegend } from '../../store/MapStore'
        ...
        { !this.state.editing ? null :
          <StyledPanelDropdown className="color-selector__dropdown">
            ...
            { legend.types.length <= 1 ? null :
              <SingleSelectFilter filter={ {
                ...
                setFilter={ type => this.props.updateLegend(this.props.layerName, { type }) }/>
            }
            ...
            }
          {
            COLOR_RANGES[this.state.length]
              ...
              .map((cr, i) => {
                return <div key={ i } onClick={ e => this.props.updateLegend(this.props.layerName, { range: cr.colors.slice() }) }>
...
export default connect(mapStateToProps, mapDispatchToProps)(onClickOutside(ColorSelector))