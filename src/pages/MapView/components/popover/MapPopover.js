...
import { updateTooltip } from "../../store/MapStore"
      ...
      <StyledMapPopover
        ...
        { pinned ?
          <div className="map-popover__top">
            ...
            <StyledPin className="popover-pin" onClick={e => this.props.updateTooltip({ pinned: false, data: [] })}>
              <Pin height="16px" />
            </StyledPin>
          </div>
        : null }
...
export default connect(mapStateToProps, mapDispatchToProps)(MapPopover)